...
public class ReservaDAO extends GeralDAO{
        private final String INSERT = "insert into tbl_salas_reservadas (data,horario,"
            ...
            public reservas getReservaByHorario(int num_sala, Date data, String horario) throws SQLException{
            ...
            public List<reservas> getReservas(Date data) throws SQLException{
            ...
            private reservas popularReserva(ResultSet resultado) throws SQLException{
                ...
                r.setData(resultado.getDate("data"));
